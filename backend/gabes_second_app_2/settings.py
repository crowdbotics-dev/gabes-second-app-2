"""
Django settings for gabes_second_app_2 project.
...
ROOT_URLCONF = 'gabes_second_app_2.urls'
...
WSGI_APPLICATION = 'gabes_second_app_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gabes_second_app_2 API",
    "DESCRIPTION": "API documentation for gabes_second_app_2 App",
    "VERSION": "v1",
}
